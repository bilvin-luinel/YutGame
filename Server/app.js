...
//     })
//     ws.on('close', () => {
//         console.log("클라이언트 하나 회원가입 서버에서 나감");
//     })
// });
...
const loginServer = require('socket.io')(8484);
console.log("Login server is running port 8484");

loginServer.on('connection', (sc) => {
    console.log("새 클라이언트 어서 오고");
})
loginServer.on('disconnect', () => {
    console.log("잘 가고 클라이언트^^");
})